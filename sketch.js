...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    //increasing the velodcity of monster
    monsterGroup.setVelocityEach=-(8+(score/8));

    //increasing the velodcity of fruit
    fruitGroup.setVelocityEach=-(8+(score/4));
    ...
    else
    {
      ...
      if(monsterGroup.isTouching(knife)){
        ...
        fruitGroup.setVelocityXEach(0, 0);
        monsterGroup.setVelocityYEach(0, 0);
